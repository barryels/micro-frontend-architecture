...
flowchart TD
  ...
  subgraph HOME["Home"]
    HOME__MAIN["Main"]
    HOME__VENDOR_LIBRARIES["Vendor Libraries"]:::vendorLibraries
  end

  subgraph USER_PROFILE["User Profile"]
    USER_PROFILE__MAIN["Main"]
    USER_PROFILE__VENDOR_LIBRARIES["Vendor Libraries"]:::vendorLibraries
  end
  ...
  HOME__MAIN -- uses --> HOME__VENDOR_LIBRARIES
  ...
  USER_PROFILE__MAIN -- uses --> USER_PROFILE__VENDOR_LIBRARIES
